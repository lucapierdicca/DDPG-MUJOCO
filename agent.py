...
class DDPG():
	...
	def __init__(self,parameters):
		...
		self.env = gym.make(self.parameters['env'][:self.parameters['env'].find('_')])
	...
	def test(self):
		...
		saver.restore(sess, tf.train.latest_checkpoint('./weights/HalfCheetah-v2_kirkiles_train50episode_noise_norm_bufsize1Mi1k'))
